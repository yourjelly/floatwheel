...
void USART1_IRQHandler(void)
{
	...
	if((USART1->ISR & USART_ISR_RXNE) != 0)	//�����ж�
	{
		USART_ClearFlag(USART1,USART_FLAG_RXNE);
		VESC_RX_Buff[count++] = USART1->RDR; //���յ������ݷ�����ջ�����
	}
	if((USART1->ISR & USART_ISR_IDLE) != 0) //�����ж�
	{
		count = 0; //һ֡���ݽ����� �±�����
		VESC_RX_Flag = 1; //���ձ�־λ��1
		USART_ClearFlag(USART1,USART_ISR_IDLE);
		USART_ReceiveData(USART1);
	}
	if((USART1->ISR & USART_ISR_ORE) != 0)  //����ж�
	{
